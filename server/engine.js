...
const DECK_TABLE = {
  "Rat":[8,10,12,14,16], "Health Inspection":[9,12,15,18,21],
  "Hot Ratato":[10,12,14,16,18], "Block":[4,5,6,7,8],
  "Food":[6,8,9,10,12], "Held Rat":[2,2,2,2,2],
  "Infestation":[2,2,2,2,2], "Plague":[1,1,1,1,1],
  "Setup":[2,2,2,2,2], "Fortify":[2,2,3,4,4],
  ...
  "Redirect CCW":[1,1,1,1,1], "Kitchen Fusion":[1,1,1,2,2],
  "Scout":[1,1,2,2,2], "Rat Away":[2,2,2,2,2],
  "Kleptomaniac":[3,4,5,6,6],
  "Surge":[1,1,2,2,2], "WD: Frenzy":[2,2,2,2,2],
  "WD: Blackout":[1,1,1,1,1], "WD: Rat Run CW":[1,1,1,1,1],
  "WD: Rat Run CCW":[1,1,1,1,1], "WD: Audit":[1,1,1,1,1],
  "WD: Curfew":[1,1,1,1,1],
};
